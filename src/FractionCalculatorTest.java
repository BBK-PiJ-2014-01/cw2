...
public class FractionCalculatorTest {
    public static void main(String[] args) {
        ...
        FractionTest.test(new Fraction(1, 2),c.evaluate(new Fraction(-1,2),"a"),"Error ABS-T1: in 'evaluate method' with 'negate' command");
        FractionTest.test(new Fraction(1, 2),c.evaluate(new Fraction(-1,2),"A"),"Error ABS-T2: in 'evaluate method' with 'negate' command");
        FractionTest.test(new Fraction(1, 2),c.evaluate(new Fraction(-1,2),"abs"),"Error ABS-T3: in 'evaluate method' with 'negate' command");
        FractionTest.test(new Fraction(1, 2),c.evaluate(new Fraction(-1,2),"Abs"),"Error ABS-T4: in 'evaluate method' with 'negate' command");
        FractionTest.test(new Fraction(1, 2),c.evaluate(new Fraction(-1,2),"ABS"),"Error ABS-T5: in 'evaluate method' with 'negate' command");
    }
}
